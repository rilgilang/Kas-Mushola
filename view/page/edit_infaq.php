                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post" action="edit_infaq.php?id=<?= $infaq_id ?>">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="id_infaq" name="id_infaq" value="<?= $infaq['id_infaq'] ?>" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="jenis_infaq" name="jenis_infaq" value="<?= $infaq['jenis_infaq'] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="jml_infaq" placeholder="Jumlah" name="jml_infaq" value="<?= $infaq['jml_infaq'] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="date" class="form-control" id="tgl_infaq" name="tgl_infaq" value="<?= $infaq['tgl_infaq'] ?>">
                                        </div>
                                    </div>

                                    <button type="submit" class="btn btn-primary me-2">Submit</button>
                                    <button type="button" class="btn btn-light" onclick="window.location.href='infaq.php'">Cancel</button>
                                </form>
                            </div>
                        </div>
                    </div>
