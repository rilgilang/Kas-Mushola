...
$kas_masuk_id = $_GET['id'];
$kas_masuk = getKasMasukById($kas_masuk_id);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = updateKasMasuk($kas_masuk_id, $data);
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post" action="edit_kas_masuk.php?id=<?= $kas_masuk['id_kasmasuk'] ?>">
                                    <div class="form-group row">
                                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">ID Kas Masuk</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="id_kasmasuk" value="<?= $kas_masuk['id_kasmasuk'] ?>" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3 align-self-center">
                                            <select class="form-control" id="id_infaq" name="id_infaq" <?= $kas_masuk['jenis_kasmasuk'] != 'infaq' ? 'disabled' : '' ?>>
                                                <option value="" selected>Pilih Id infaq</option>
                                                <?php foreach ($infaqList as $key => $infaq) { ?>
                                                    <option value="<?= $infaq['id_infaq'] ?>" <?= $kas_masuk['id_infaq'] == $infaq['id_infaq'] ? 'selected' : '' ?>><?= $infaq['id_infaq'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3 align-self-center">
                                            <select class="form-control" id="id_donasi" name="id_donasi" <?= $kas_masuk['jenis_kasmasuk'] != 'donasi' ? 'disabled' : '' ?>>
                                                <option value="" selected>Pilih Id donasi</option>
                                                <?php foreach ($donasiList as $key => $donasi) { ?>
                                                    <option value="<?= $donasi['id_donasi'] ?>" <?= $kas_masuk['id_donasi'] == $donasi['id_donasi'] ? 'selected' : '' ?>><?= $donasi['id_donasi'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="date" class="form-control" placeholder="DD/MM/YYYY" name="tgl_kasmasuk" value="<?= $kas_masuk['tgl_kasmasuk'] ?>">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Keterangan Kas Masuk</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="4" id="ket_kasmasuk" name="ket_kasmasuk"><?= $kas_masuk['ket_kasmasuk'] ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="Jumlah" id="jml_kasmasuk" name="jml_kasmasuk" value="<?= $kas_masuk['jml_kasmasuk'] ?>">
                                        </div>
                                    </div>
